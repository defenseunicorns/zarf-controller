...
import (
	...
	"github.com/defenseunicorns/zarf-controller/controllers"
...
func init() {
	...
	utilruntime.Must(zarfdevv1beta1.AddToScheme(scheme))
...
// XXX(runyontr) I dont think this fixed anything for me. can probably delete
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d8cf54fc.zarf.dev",
